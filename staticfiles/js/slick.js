    ...
    b = function() {
        function c(c, d) {
            ...
            if (e.defaults = {
                    ...
                    arrows: !0,
                    asNavFor: null,
                    prevArrow: '<button type="button" data-role="none" class="slick-prev" aria-label="previous"><i class="fa fa-angle-left" aria-hidden="true"></i></button>',
                    nextArrow: '<button type="button" data-role="none" class="slick-next" aria-label="next"><i class="fa fa-angle-right" aria-hidden="true"></i></button>',
                    autoplay: !1,
                    autoplaySpeed: 3e3,
                    centerMode: !1,
                    centerPadding: "50px",
